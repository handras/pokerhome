package hu.bandris_1994.pokerhome.util;
...
public class PokerRank {
    ...
    private ArrayList<Card> cards = new ArrayList<Card>();  // The cards in this hand.
     ...
     *    is greater than five.
     */
    public PokerRank(ArrayList<Card> cards) {
        if (cards != null) {
            for (Card c : cards)
                add(c);
        }
    ...
    private void computeRank() {
        ...
        try {
            ...
            if (cards.size() == 5) {
                ...
                if (cards.get(0).getValue() == Card.ACE && cards.get(1).getValue() == 5
            ...
            if (pairLoc1 > 0) {
                ...
                // the start.
                Card p2 = cards.remove(pairLoc1+1);
                Card p1 = cards.remove(pairLoc1);
                cards.add(0,p2);
                cards.add(0,p1);
            }
            ...
            if (pairLoc2 > 2) {
                ...
                Card p2 = cards.remove(pairLoc2+1);
                Card p1 = cards.remove(pairLoc2);
                cards.add(2,p2);
                cards.add(2,p1);
            }
